...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='aphid4k',
                        choices=['voc', 'coco', 'bdd', 'cityscapes', 'aphid4k'],
                        help='Dataset to use')
    ...
    parser.add_argument('--learning_sched', type=list, default=[70, 90],
    ...
    parser.add_argument('--mobilenet_v3_model', type=str, default='l',
                        choices=['s', 'l'],
    ...
    # aphid-4k dataset
    parser.add_argument('--aphid4k_data_path', type=str,
                        default='datasets/Aphid-4k/',
                        help='Aphid-4K dataset path')
